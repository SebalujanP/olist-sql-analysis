...
### 1. ¿El tiempo de entrega afecta la satisfacción del cliente?
...
### 2. ¿Qué categorías de producto y regiones generan más facturación?
...
Se calcularon las 3 métricas clásicas de segmentación por cliente, combinadas con **CTEs**:
...
El dashboard tiene 4 páginas, una por cada pregunta de negocio, conectadas en vivo a la base PostgreSQL:

- Rentabilidad por categoría/región (con filtro por estado)
- Entrega vs. review score
